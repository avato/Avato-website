    ...
    <div className={`h-screen w-screen flex justify-center items-center`} >
      <div className="container mx-auto flex items-center justify-center">
        <div className="flex-1 w-3/6 text-center items-center justify-center">
          ...
          <h1 className="my-7 text-7xl text-primary-500 font-black fancyFont" >A J</h1>
          ...
          <div className="byline mt-24">
            ...
            <div className="text-center my-8 uppercase text-5xl text-primary-500 font-black tracking-widest1 fancyFont" >light and bytes </div>
